...
def szereguj_instancje(nazwa_instancji, liczba_wezlow):
    ...
    nazwa_pliku_wyjsciowego = "../uszeregowanie/szer-jnq-n" + "%03d-" % liczba_wezlow + nazwa_instancji
    nazwa_pliku_wyjsciowego_nodes = "../uszeregowanie/szer-jnq-n" + "%03d-nodes-" % liczba_wezlow + nazwa_instancji
