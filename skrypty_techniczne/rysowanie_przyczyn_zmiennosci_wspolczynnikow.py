...
def rysuj_przyczyne_zmiennosci_czasow_przedkladania(liczba_faz):
    ...
    plt.suptitle("Histogramy wartosci czasow przedkladania (liczba faz: " + str(liczba_faz) + ")", fontsize=30, y=0.92)
...
def rysuj_przyczyne_zmiennosci_rozmiarow(liczba_faz):
    ...
    plt.rcParams["figure.figsize"] = (ncols * 10, nrows * 7)
    plt.suptitle("Histogramy wartosci rozmiarow (liczba faz: " + str(liczba_faz) + ")", fontsize=30, y=0.92)
